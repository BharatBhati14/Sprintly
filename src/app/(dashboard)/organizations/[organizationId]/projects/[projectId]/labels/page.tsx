...
export default function ProjectLabelsPage() {
  ...
  const loading = organizationLoading || projectLoading || labelsLoading;

  if (loading) {
    return (
      <AppShell>
        {" "}
        <div className="space-y-6 px-4 py-4 sm:px-6 lg:px-8 md:py-6">
          {" "}
    ...
    return (
      <AppShell>
        ...
        <Card>
          ...
          <div className="p-6">
            {" "}
            <p className="text-sm text-zinc-600">Project not found. </p>{" "}
          </div>{" "}
        </Card>{" "}
      </AppShell>
    );
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-zinc-500">
                Manage labels used across {project.name}.
              </p>
            </div>
